...
class Bubble:
    r = -1.0 #raio
    pos = Vec2()#vetor de posicao
    vel = Vec2()#vetor de velocidade
    color = -1 #cor

    #inicializar a bola aleatoriamente
    def rand(self):
    ...
    #atualizar posicao da bola a partir de suas velocidades vertical (y) e horizontal (x)
    def update(self):
...
class App:
    ...
    def update(self):
        ...
        #detectar se o mouse esta cliado
        if pyxel.btnp(pyxel.KEY_LEFT_BUTTON):
            for i in range(0, num_bubbles):
                ...
                #detectar qual bola foi clicada
        ...
        #iterar sobre todas as bolas, atualizar posicoes
